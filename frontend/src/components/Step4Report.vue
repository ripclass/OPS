...
const toggleRawResult = (timestamp, event) => {
  ...
  // Wait for DOM updates before adjusting scroll position to keep the button in the same place
...
const toolConfig = {
  ...
  'panorama_search': {
    ...
    color: 'blue',
    icon: 'globe' // Earth Icon - Represents Panoramic Search
  },
  'interview_agents': {
    name: 'Agent Interview',
    color: 'green',
    icon: 'users' // User Icon - Represents Chat
  },
  'quick_search': {
    name: 'Quick Search',
    color: 'orange',
    icon: 'zap' // Flash Icon - Represents Quick
  },
    ...
    return () => h('div', { class: 'quick-search-display' }, [
      ...
      h('div', { class: 'quicksearch-header' }, [
        ...
        props.result.query && h('div', { class: 'header-query' }, [
          h('span', { class: 'query-label' }, '%E6%90%9C%E7%B4%A2: '),
      ...
      h('div', { class: ['quicksearch-content', { 'no-tabs': !showTabs.value }] }, [
        ...
        ((!showTabs.value) || activeTab.value === 'facts') && h('div', { class: 'facts-panel' }, [
          !showTabs.value && h('div', { class: 'panel-header' }, [
            h('span', { class: 'panel-title' }, '%E6%90%9C%E7%B4%A2%E7%BB%93%E6%9E%9C'),
            h('span', { class: 'panel-count' }, `%E5%85%B1 ${props.result.facts.length} %E6%9D%A1`)
          ]),
          ...
          ) : h('div', { class: 'empty-state' }, '%E6%9C%AA%E6%89%BE%E5%88%B0%E7%9B%B8%E5%85%B3%E7%BB%93%E6%9E%9C'),
          props.result.facts.length > INITIAL_SHOW_COUNT && h('button', {
            class: 'expand-btn',
            onClick: () => { expandedFacts.value = !expandedFacts.value }
          }, expandedFacts.value ? `%E6%94%B6%E8%B5%B7 ▲` : `%E5%B1%95%E5%BC%80%E5%85%A8%E9%83%A8 ${props.result.facts.length} %E6%9D%A1 ▼`)
        ]),
        
        // Edges Tab
        activeTab.value === 'edges' && hasEdges.value && h('div', { class: 'edges-panel' }, [
          h('div', { class: 'panel-header' }, [
            h('span', { class: 'panel-title' }, '%E7%9B%B8%E5%85%B3%E5%85%B3%E7%B3%BB'),
            h('span', { class: 'panel-count' }, `%E5%85%B1 ${props.result.edges.length} %E6%9D%A1`)
          ]),
        ...
        activeTab.value === 'nodes' && hasNodes.value && h('div', { class: 'nodes-panel' }, [
          h('div', { class: 'panel-header' }, [
            h('span', { class: 'panel-title' }, '%E7%9B%B8%E5%85%B3%E8%8A%82%E7%82%B9'),
            h('span', { class: 'panel-count' }, `%E5%85%B1 ${props.result.nodes.length} %E4%B8%AA`)
          ]),
...
// %E5%BD%93%E5%89%8D%E6%B4%BB%E8%B7%83%E7%9A%84%E6%AD%A5%E9%AA%A4（%E7%94%A8%E4%BA%8E%E9%A1%B6%E9%83%A8%E6%98%BE%E7%A4%BA）
const activeStep = computed(() => {
  const steps = workflowSteps.value
  // %E6%89%BE%E5%88%B0%E5%BD%93%E5%89%8D active %E7%9A%84%E6%AD%A5%E9%AA%A4
  const active = steps.find(s => s.status === 'active')
  if (active) return active
  
  // %E5%A6%82%E6%9E%9C%E6%B2%A1%E6%9C%89 active，%E8%BF%94%E5%9B%9E%E6%9C%80%E5%90%8E%E4%B8%80%E4%B8%AA done %E7%9A%84%E6%AD%A5%E9%AA%A4
  const doneSteps = steps.filter(s => s.status === 'done')
  if (doneSteps.length > 0) return doneSteps[doneSteps.length - 1]
  
  // %E5%90%A6%E5%88%99%E8%BF%94%E5%9B%9E%E7%AC%AC%E4%B8%80%E4%B8%AA%E6%AD%A5%E9%AA%A4
  return steps[0] || { noLabel: '--', title: '%E7%AD%89%E5%BE%85%E5%BC%80%E5%A7%8B', status: 'todo', meta: '' }
})
...
const renderMarkdown = (content) => {
  ...
  // %E5%8E%BB%E6%8E%89%E5%BC%80%E5%A4%B4%E7%9A%84%E4%BA%8C%E7%BA%A7%E6%A0%87%E9%A2%98（## xxx），%E5%9B%A0%E4%B8%BA%E7%AB%A0%E8%8A%82%E6%A0%87%E9%A2%98%E5%B7%B2%E5%9C%A8%E5%A4%96%E5%B1%82%E6%98%BE%E7%A4%BA
  ...
  // Clean up <p><br> following block-level elements (due to extra line breaks)
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Clean up consecutive <br> tags
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Clean up <br> before paragraph start tag following block-level elements
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix numbering in non-continuous ordered lists: keep the number sequence continuous when single <ol> is separated by paragraph content
...
const getLogLevelClass = (log) => {
  if (log.includes('ERROR') || log.includes('%E9%94%99%E8%AF%AF')) return 'error'
  if (log.includes('WARNING') || log.includes('%E8%AD%A6%E5%91%8A')) return 'warning'
  // INFO %E4%BD%BF%E7%94%A8%E9%BB%98%E8%AE%A4%E9%A2%9C%E8%89%B2，%E4%B8%8D%E6%A0%87%E8%AE%B0%E4%B8%BA success
  return ''
}
    ...
    if (res.success && res.data) {
      ...
      if (newLogs.length > 0) {
        ...
        newLogs.forEach(log => {
          ...
          // section_complete - %E7%AB%A0%E8%8A%82%E7%94%9F%E6%88%90%E5%AE%8C%E6%88%90
          if (log.action === 'section_complete') {
            if (log.details?.content) {
              generatedSections.value[log.section_index] = log.details.content
              // %E8%87%AA%E5%8A%A8%E5%B1%95%E5%BC%80%E5%88%9A%E7%94%9F%E6%88%90%E7%9A%84%E7%AB%A0%E8%8A%82
        ...
        nextTick(() => {
          if (rightPanel.value) {
            // %E5%A6%82%E6%9E%9C%E4%BB%BB%E5%8A%A1%E5%B7%B2%E5%AE%8C%E6%88%90，%E6%BB%9A%E5%8A%A8%E5%88%B0%E9%A1%B6%E9%83%A8；%E5%90%A6%E5%88%99%E6%BB%9A%E5%8A%A8%E5%88%B0%E5%BA%95%E9%83%A8%E8%B7%9F%E9%9A%8F%E6%9C%80%E6%96%B0%E6%97%A5%E5%BF%97
            if (isComplete.value) {
...
// %E6%8F%90%E5%8F%96%E6%9C%80%E7%BB%88%E7%AD%94%E6%A1%88%E5%86%85%E5%AE%B9 - %E4%BB%8E LLM response %E4%B8%AD%E6%8F%90%E5%8F%96%E7%AB%A0%E8%8A%82%E5%86%85%E5%AE%B9
const extractFinalContent = (response) => {
  if (!response) return null
  
  // %E5%B0%9D%E8%AF%95%E6%8F%90%E5%8F%96 <final_answer> %E6%A0%87%E7%AD%BE%E5%86%85%E7%9A%84%E5%86%85%E5%AE%B9
  ...
  // %E5%B0%9D%E8%AF%95%E6%89%BE Final Answer: %E5%90%8E%E9%9D%A2%E7%9A%84%E5%86%85%E5%AE%B9（%E6%94%AF%E6%8C%81%E5%A4%9A%E7%A7%8D%E6%A0%BC%E5%BC%8F）
  // %E6%A0%BC%E5%BC%8F1: Final Answer:\n\n%E5%86%85%E5%AE%B9
  // %E6%A0%BC%E5%BC%8F2: Final Answer: %E5%86%85%E5%AE%B9
  const finalAnswerMatch = response.match(/Final\s*Answer:\s*\n*([\s\S]*)$/i)
  if (finalAnswerMatch) {
    return finalAnswerMatch[1].trim()
  }
  
  // %E5%B0%9D%E8%AF%95%E6%89%BE %E6%9C%80%E7%BB%88%E7%AD%94%E6%A1%88: %E5%90%8E%E9%9D%A2%E7%9A%84%E5%86%85%E5%AE%B9
  const chineseFinalMatch = response.match(/%E6%9C%80%E7%BB%88%E7%AD%94%E6%A1%88[:：]\s*\n*([\s\S]*)$/i)
  if (chineseFinalMatch) {
    return chineseFinalMatch[1].trim()
  }
  
  // %E5%A6%82%E6%9E%9C%E4%BB%A5 ## %E6%88%96 # %E6%88%96 > %E5%BC%80%E5%A4%B4，%E5%8F%AF%E8%83%BD%E6%98%AF%E7%9B%B4%E6%8E%A5%E7%9A%84 markdown %E5%86%85%E5%AE%B9
  const trimmedResponse = response.trim()
  if (trimmedResponse.match(/^[#>]/)) {
    return trimmedResponse
  }
  
  // %E5%A6%82%E6%9E%9C%E5%86%85%E5%AE%B9%E8%BE%83%E9%95%BF%E4%B8%94%E5%8C%85%E5%90%ABmarkdown%E6%A0%BC%E5%BC%8F，%E5%B0%9D%E8%AF%95%E7%A7%BB%E9%99%A4%E6%80%9D%E8%80%83%E8%BF%87%E7%A8%8B%E5%90%8E%E8%BF%94%E5%9B%9E
  if (response.length > 300 && (response.includes('**') || response.includes('>'))) {
    // %E7%A7%BB%E9%99%A4 Thought: %E5%BC%80%E5%A4%B4%E7%9A%84%E6%80%9D%E8%80%83%E8%BF%87%E7%A8%8B
...
.section-number {
  ...
  font-size: 16px;
  color: #9CA3AF; /* Deep gray color, does not change with state */
  font-weight: 500;
}
