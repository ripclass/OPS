              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Align real-world seed data with the simulated environment state, integrating Global/Local Memory mechanisms for cross-temporal deep attribution analysis</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Based on a breadth-first traversal algorithm of graph structures, reconstruct event propagation paths and capture the topological structure of full information flow</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">A real-time query interface based on GraphRAG, optimizing index efficiency for quick extraction of specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews capable of conducting multi-round dialogues in parallel with individuals in the simulated world, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">Profile Summary</div>
          ...
          <div class="survey-setup">
            <div class="setup-section">
              ...
              <div class="selection-actions">
                ...
                <button class="action-link" @click="clearAgentSelection">Clear Selection</button>
              </div>
            </div>
...
// Save current chat record to cache
...
const selectReportAgentChat = () => {
  ...
  // Restore the Report Agent's conversation record
...
const selectAgent = (agent, idx) => {
  ...
  // Restore this Agent's conversation record
...
const renderMarkdown = (content) => {
  ...
  // Process list - supports sub-lists
  ...
  // Clean up whitespace after the opening list tag
  html = html.replace(/<ul class="md-ul">\s+/g, '<ul class="md-ul">')
  html = html.replace(/<ol class="md-ol">\s+/g, '<ol class="md-ol">')
  // Clean up whitespace before the closing list tag
  ...
  // Clean up cases where a <p><br> follows a block-level element (due to extra blank lines)
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Clean up consecutive <br> tags
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Clean up <br> tags before the opening paragraph tag that follows a block-level element
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix numbering in non-continuous ordered lists: keep numbering incremental when single <ol> is separated by paragraph content
...
const sendMessage = async () => {
  ...
  try {
    ...
    scrollToBottom()
    // Automatically save the conversation log to cache
    saveChatHistory()
  }
}
...
const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('Please select a simulation subject first')
  }
...
/* Left Panel - Report Style (completely consistent with Step4Report.vue) */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
  background: #FFFFFF;
...
/* Fix ordered list numbering - use CSS counters to continue numbering multiple ol elements consecutively */
.message-text {
...
/* styles for the chat/survey area */
