...
logger = get_logger('ops.simulation_ipc')
...
class SimulationIPCClient:
    ...
    def send_command(
        ...
        Raises:
            TimeoutError: Raised when waiting for the response times out
        """
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's `platform`)
                ...
                - None: in dual-platform simulations, each agent is interviewed on both platforms
            timeout: Timeout
...
class SimulationIPCServer:
    ...
    def poll_commands(self) -> Optional[IPCCommand]:
        ...
        # Get command files sorted by timestamp
        command_files = []
