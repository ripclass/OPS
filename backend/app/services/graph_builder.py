...
class GraphBuilderService:
    ...
    def create_graph(self, name: str) -> str:
        ...
        graph_id = f"ops_{uuid.uuid4().hex[:16]}"
        
        self.client.graph.create(
            graph_id=graph_id,
            name=name,
            description="OPS Social Simulation Graph"
        )
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # Reserved Zep names cannot be used as attribute names.
        ...
        for entity_def in ontology.get("entity_types", []):
            ...
            for attr_def in entity_def.get("attributes", []):
                ...
                # The Zep API requires `Field.description`.
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        """
        Get the full graph data, including detailed metadata.
